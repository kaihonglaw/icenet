...
python analysis/dqcd_deploy.py --use_conditional 0 --inputmap 'include/scenarioA_deploy.yml' --modeltag scenarioA_all_model_points_no_conditional --grid_id $GRID_ID --grid_nodes $GRID_NODES --config $CONFIG --datapath $DATAPATH
